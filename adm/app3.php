...
<div class="col-md-2">
    ...
    <a href="app3.php" class="btn-success">SSCE Examination</a> <br><br>
...
<div class="col-md-8" style="padding-left: 2%;">
    <fieldset id="p1"><legend>SSCE Examination</legend>SSCE Examination and Results
...
<table width="90%" border="0" align="center">
                                                ...
                                                <tr><td>Name of Examination</td>
                                                    <td><input type="text" class="form-control" value="<?php echo $rows['examname'];  ?>" name="examname" placeholder="type of exam ">
                                                </td></tr>
                                                
                                                <tr><td>Date</td>
                                                    <td><input type="text" class="form-control" value="<?php echo $rows['examdate'];  ?>" name="examdate" placeholder="date the exam was written"></td>
                                                </tr>
                                                <tr><td>Examination Center</td>
                                                    <td><input type="text" class="form-control" value="<?php echo $rows['examcenter'];  ?>" name="examcenter" placeholder="Your Exam center"></td>
                                                </tr>
                                                <tr><td>Examination No</td>
                                                    <td><input type="text" class="form-control" value="<?php echo $rows['examno'];  ?>" name="examno" placeholder="Exam Number"></td>
                                                </tr>
                                                <tr><td>Subjects + Grades</td>
                                                    <td>
                                                        <textarea rows="5" class="form-control" cols="40" name="Subngrade" placeholder="outline subjects offered and grade accordingly (Mathematice=A1, English=A1, ...)"><?php echo $rows['Subngrade'];  ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr><td>Other Examination(s)</td>
                                                    <td>
                                                        <textarea rows="10" class="form-control" cols="40" name="otherexam" placeholder="list other examination(s) taken with date(s). specify the subject taken in the examination"><?php echo $rows['otherexam'];  ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr><td>Honours</td>
                                                    <td>
                                                        <textarea rows="10" class="form-control" cols="40" name="honour" placeholder="Prizes, Distinction and honours won with dates"><?php echo $rows['honour'];  ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr><td></td>
                                                    <td>
