...
<div class="col-md-2">
    ...
    <a href="app5.php" class="btn-success">Employment Experience</a> <br><br>
...
<div class="col-md-8" style="padding-left: 2%;">
                                        ...
                                        <table width="90%" border="0" align="center">
                                                ...
                                                <tr><td>Name of Employers</td>
                                                    <td><input class="form-control" type="text" value="<?php echo $rows['employname'];  ?>" name="employname" placeholder=" ">
                                                </td></tr>
                                                <tr><td>Address</td>
                                                    <td><textarea class="form-control" rows="3" cols="40" name="addemploy" placeholder=""><?php echo $rows['addemploy'];  ?></textarea></td>
                                                </tr>
                                                <tr><td>Nature of Work</td>
                                                    <td><input class="form-control" type="text" value="<?php echo $rows['naturewrk'];  ?>" name="naturewrk" placeholder=""></td>
                                                </tr>
                                                <tr><td>Other Experience</td>
                                                    <td>
                                                        <textarea class="form-control" rows="5" cols="40" name="otheremploy" placeholder="Other Experience, give date(s) and Nature of work"><?php echo $rows['otheremploy'];  ?></textarea>
                                                    </td>
                                                </tr>
