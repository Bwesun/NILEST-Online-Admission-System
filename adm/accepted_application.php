...
<fieldset>
  <legend>Accepted Admission Applications</legend>
...
$sql="SELECT * FROM admin WHERE admissionstatus='accepted' ORDER BY id DESC ";
...
?>
    ...
    <tr>
      ...
      <td><a href="app_index.php?id=<?php echo $rows['id'] ; ?>" class="btn btn-primary" >View</a></td>
    </tr>
<?php
}
